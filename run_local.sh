...
echo "==> Starting Reflex frontend on :3003 (state backend :8003)"
reflex run --frontend-port 3003 --backend-port 8003 &
FRONTEND_PID=$!
...
echo "Frontend: http://localhost:3003   (login: demo1@demo.com / demo1)"
